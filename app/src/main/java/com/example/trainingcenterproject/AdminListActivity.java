...
public class AdminListActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        DataBaseHelper dataBaseHelper =new DataBaseHelper(AdminListActivity.this,"training", null,1);
        Cursor allCoursesCursor = dataBaseHelper.getAllAdmins();
        xLinearLayout.removeAllViews();
        while (allCoursesCursor.moveToNext()){
            TextView textView =new TextView(AdminListActivity.this);
            textView.setText(
