...
public class InstructorListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xbackButton.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View view) {
                Intent intent = new Intent(InstructorListActivity.this, MainActivity.class);
    ...
    protected void onResume() {
        super.onResume();
        DataBaseHelper dataBaseHelper =new DataBaseHelper(InstructorListActivity.this,"training", null,1);
        Cursor allCoursesCursor = dataBaseHelper.getAllInstructors();
        xLinearLayout.removeAllViews();
        while (allCoursesCursor.moveToNext()){
            TextView textView =new TextView(InstructorListActivity.this);
            textView.setText(
